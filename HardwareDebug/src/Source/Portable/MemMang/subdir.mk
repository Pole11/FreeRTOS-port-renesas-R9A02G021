...
C_SRCS += \
../src/Source/Portable/MemMang/heap_1.c 

CREF += \
FreeRTOS_port_prod2.cref 

C_DEPS += \
./src/Source/Portable/MemMang/heap_1.d 

OBJS += \
./src/Source/Portable/MemMang/heap_1.o 
...
src/Source/Portable/MemMang/%.o: ../src/Source/Portable/MemMang/%.c
	@echo 'Building file: $<'
