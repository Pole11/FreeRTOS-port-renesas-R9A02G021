...
void R_Config_PORT_Create(void)
{
    ...
    R_PFS->P104PFS = _00000000_Pn04PFS_PULLUP_OFF | _00000000_Pn04PFS_CMOS_OUTPUT | 
                     ...
                     _00000004_Pn04PFS_MODE_OUTPUT | _00000000_Pn04PFS_GPIO_USED;
    ...
    /* Set PORT2 registers */
    R_PFS->P207PFS = _00000000_Pn07PFS_PULLUP_OFF | _00000000_Pn07PFS_CMOS_OUTPUT | 
                     _00000000_Pn07PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn07PFS_OUTPUT_LOW | 
                     _00000004_Pn07PFS_MODE_OUTPUT | _00000000_Pn07PFS_GPIO_USED;
    R_PFS->P206PFS = _00000000_Pn06PFS_PULLUP_OFF | _00000000_Pn06PFS_CMOS_OUTPUT | 
                     _00000000_Pn06PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn06PFS_OUTPUT_LOW | 
                     _00000000_Pn06PFS_MODE_UNUSED;
    R_PFS->P205PFS = _00000000_Pn05PFS_PULLUP_OFF | _00000000_Pn05PFS_CMOS_OUTPUT | 
                     _00000000_Pn05PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn05PFS_OUTPUT_LOW | 
                     _00000000_Pn05PFS_MODE_UNUSED;
    R_PFS->P204PFS = _00000000_Pn04PFS_PULLUP_OFF | _00000000_Pn04PFS_CMOS_OUTPUT | 
                     _00000000_Pn04PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn04PFS_OUTPUT_LOW | 
                     _00000000_Pn04PFS_MODE_UNUSED;
    R_PFS->P203PFS = _00000010_Pn03PFS_PULLUP_ON | _00000000_Pn03PFS_CMOS_OUTPUT | 
                     _00000000_Pn03PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn03PFS_OUTPUT_LOW | 
                     _00000000_Pn03PFS_MODE_UNUSED;
    R_PFS->P202PFS = _00000000_Pn02PFS_PULLUP_OFF | _00000000_Pn02PFS_CMOS_OUTPUT | 
                     _00000000_Pn02PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn02PFS_OUTPUT_LOW | 
                     _00000000_Pn02PFS_MODE_UNUSED;
    R_PFS->P201PFS = _00000000_Pn01PFS_PULLUP_OFF | _00000000_Pn01PFS_CMOS_OUTPUT | 
                     _00000000_Pn01PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn01PFS_OUTPUT_LOW | 
                     _00000000_Pn01PFS_MODE_UNUSED;
    R_PFS->P200PFS = _00000000_Pn00PFS_ELC_EDGE_DETECT_NONE | _00000000_Pn00PFS_MODE_UNUSED;
    R_PORT2->EOSR = _0000_EOSRn07_EVENT_OUTPUT_NOEFFECT | _0000_EOSRn06_EVENT_OUTPUT_NOEFFECT | 
                    _0000_EOSRn05_EVENT_OUTPUT_NOEFFECT | _0000_EOSRn04_EVENT_OUTPUT_NOEFFECT | 
                    _0000_EOSRn03_EVENT_OUTPUT_NOEFFECT | _0000_EOSRn02_EVENT_OUTPUT_NOEFFECT | 
                    _0000_EOSRn01_EVENT_OUTPUT_NOEFFECT;
    R_PORT2->EORR = _0000_EORRn07_EVENT_OUTPUT_NOEFFECT | _0000_EORRn06_EVENT_OUTPUT_NOEFFECT | 
                    _0000_EORRn05_EVENT_OUTPUT_NOEFFECT | _0000_EORRn04_EVENT_OUTPUT_NOEFFECT | 
                    _0000_EORRn03_EVENT_OUTPUT_NOEFFECT | _0000_EORRn02_EVENT_OUTPUT_NOEFFECT | 
                    _0000_EORRn01_EVENT_OUTPUT_NOEFFECT;

    /* Set PORT3 registers */
    R_PFS->P307PFS = _00000000_Pn07PFS_PULLUP_OFF | _00000000_Pn07PFS_CMOS_OUTPUT | _00000000_Pn07PFS_OUTPUT_LOW | 
                     _00000000_Pn07PFS_MODE_UNUSED;
    R_PFS->P306PFS = _00000000_Pn06PFS_PULLUP_OFF | _00000000_Pn06PFS_CMOS_OUTPUT | _00000000_Pn06PFS_OUTPUT_LOW | 
                     _00000000_Pn06PFS_MODE_UNUSED;
    R_PFS->P305PFS = _00000000_Pn05PFS_PULLUP_OFF | _00000000_Pn05PFS_CMOS_OUTPUT | _00000000_Pn05PFS_OUTPUT_LOW | 
                     _00000004_Pn05PFS_MODE_OUTPUT | _00000000_Pn05PFS_GPIO_USED;
    R_PFS->P304PFS = _00000000_Pn04PFS_PULLUP_OFF | _00000000_Pn04PFS_CMOS_OUTPUT | _00000000_Pn04PFS_OUTPUT_LOW | 
                     _00000004_Pn04PFS_MODE_OUTPUT | _00000000_Pn04PFS_GPIO_USED;
    R_PFS->P303PFS = _00010000_P303_PMR_DEFAULT_VALUE | _00000010_Pn03PFS_PULLUP_ON | _00000000_Pn03PFS_CMOS_OUTPUT | 
                     _00000000_Pn03PFS_OUTPUT_LOW | _00000000_Pn03PFS_MODE_UNUSED;
    R_PFS->P302PFS = _00010000_P302_PMR_DEFAULT_VALUE | _00000000_Pn02PFS_PULLUP_OFF | _00000000_Pn02PFS_CMOS_OUTPUT | 
                     _00000000_Pn02PFS_OUTPUT_LOW | _00000000_Pn02PFS_MODE_UNUSED;
    R_PFS->P301PFS = _00010000_P301_PMR_DEFAULT_VALUE | _00000010_Pn01PFS_PULLUP_ON | _00000000_Pn01PFS_CMOS_OUTPUT | 
                     _00000000_Pn01PFS_OUTPUT_LOW | _00000000_Pn01PFS_MODE_UNUSED;
    R_PFS->P300PFS = _00010000_P300_PMR_DEFAULT_VALUE | _00000010_Pn00PFS_PULLUP_ON | _00000000_Pn00PFS_CMOS_OUTPUT | 
                     _00000000_Pn00PFS_OUTPUT_LOW | _00000000_Pn00PFS_MODE_UNUSED;

    /* Set PORT4 registers */
    R_PFS->P403PFS = _00000000_Pn03PFS_PULLUP_OFF | _00000000_Pn03PFS_CMOS_OUTPUT | _00000000_Pn03PFS_OUTPUT_LOW | 
                     _00000000_Pn03PFS_MODE_UNUSED;
    R_PFS->P402PFS = _00000000_Pn02PFS_PULLUP_OFF | _00000000_Pn02PFS_CMOS_OUTPUT | _00000000_Pn02PFS_OUTPUT_LOW | 
                     _00000004_Pn02PFS_MODE_OUTPUT | _00000000_Pn02PFS_GPIO_USED;
    R_PFS->P401PFS = _00000000_Pn01PFS_PULLUP_OFF | _00000000_Pn01PFS_OUTPUT_LOW | _00000000_Pn01PFS_MODE_UNUSED;
    R_PFS->P400PFS = _00000000_Pn00PFS_PULLUP_OFF | _00000000_Pn00PFS_OUTPUT_LOW | _00000000_Pn00PFS_MODE_UNUSED;
