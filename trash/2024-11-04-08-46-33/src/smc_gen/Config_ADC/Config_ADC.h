...
#define AD_WAITTIME_A                   (77U)    /* wait for 4.8us as default,
                                                   please change the waiting time value according to the system */
#define AD_WAITTIME_B                   (38U)    /* wait for 1us + 2fAD as default,
                                                   please change the waiting time value according to the system */
#define AD_WAITTIME                     (4U)    /* wait for 0.2us as default,
                                                   please change the waiting time value according to the system */
...
typedef enum
{
    ...
    ADCHANNEL16 = 16U, ADCHANNEL17, ADCHANNEL18, ADCHANNEL19, ADTEMPERSENSOR0 = 128U, ADINTERREFVOLT
} e_ad_channel_t;
typedef enum
{
    ADNORMALINPUT,
